...
<div class="content-wrapper">
    <div id="login">
        ...
        <form>
            <input type = "text" id = "ID" name ="ta-id" placeholder="ID" required>
            <input type="text" id = "name" name = "ta_name" placeholder="Name" required>
            <input type="text" id = "email" name = "ta_email" placeholder="Email" required>
            <input type="text" id = "contact" name = "ta_phone" placeholder="Phone" required>
            <input type="time" id = "timings" name = "ta_timings" placeholder="Timings" required>
            ...
            <input type="text" id="class_id1"  name = "class_id" placeholder="classId" required>
